var how01 = [{	"name":"Example 01",
    				"imageURL": "images/how_example01.jpg",
    				"caption":"",
    				"guidelines": "<ul> \
    				...
    				"questions": [{
	    				"question":"Mitosis",
	    				"answer":"Nice try. This description is too high-level and does not provide sufficient details about the embedded content required to answer the question.",
	    				"correct":"no"
	    				},{
	    				"question":"Mitosis stages: Prophase, Prometaphase, Metaphase, Anaphase, and Telophase",
	    				"answer":"Good choice. The description starts with the high-level concept, and then delves into the details of the illustration.",
	    				"correct":"yes"
	    				},{
...
var how02 = [{	"name":"Example 02",
    				...
    				"questions": [{
	    				...
	    				"answer":"Good choice. This description uses language and introduces shapes appropriate for a young child.",
	    				"correct":"yes"
	    				},{
	    				...
	    				"answer":"Nice try. The description is accurate, but the use of vocabulary such as “juxtaposition” and “proclivity,” is far too complex for a young child. This might have been an appropriate description if it had been written for a more mature audience.",
	    				"correct":"no"
	    				},{
	    				...
	    				"answer":"Nice try. This description is accurate and appropriate for a photography aficionado, but provides too much detail about composition and design for the average child or adult.",
	    				"correct":"no"
	    				}]
    			}];

var how03 = [{	"name":"Example 03",
    				"imageURL": "images/how_example03.jpg",
    				...
    				"questions": [{
	    				"question":"Figure 1.1",
	    				"answer":"Good choice. The accompanying caption provides sufficient information about the photograph, so readers should be directed to the existing text.",
	    				"correct":"yes"
	    				},{
	    				...
	    				"answer":"Nice try. This description is overly detailed and repeats information introduced in the accompanying caption. The additional details about the color of the orbiting paths are excessive and not necessary for understanding the concept of orbital paths.",
	    				"correct":"no"
	    				},{
	    				...
	    				"answer":"Nice try. This description is accurate and presents facts some readers may find interesting, but new information should not be introduced through image descriptions.",
	    				"correct":"no"
	    				}]
    			}];

var how04 = [{	"name":"Example 04",
    				"imageURL": "images/how_example04.jpg",
    				"caption": "",
    				...
    				"questions": [{
						...
						"answer":"Nice try. This accurately identifies and describes the bird in the image, but omits detail about the bird defecating, which is one reason for acid erosion.",
	    				"correct":"no"
	    				},{
	    				"question":"A cute puffin doing his business on an earthy, red rock.",
						"answer":"Nice try. Describing the bird as “cute,” assigns subjectivity to the object in the photo. Furthermore, “doing his business” is ambiguous and could be considered censorship of an action the writer is uncomfortable describing.",
	    				"correct":"no"
	    				},{
						...
						"answer":"Good choice. This description quickly identifies the puffin as a bird for those who may not be familiar. It also states the bird’s current status and objectively presents defecation as a likely cause of acid erosion.",
	    				"correct":"yes"
	    				}]
    			}];
    			
var how05 = [{	"name":"Example 05",
    				"imageURL": "images/how_example05.jpg",
    				"caption": "",
    				...
    				"questions": [{
						...
						"answer":"Nice try. This description is too simplistic and lacks details about why the map is considered artistic.",
	    				"correct":"no"
	    				},{
						...
						"answer":"Good choice. This accurately starts with a high-level context about the recycled nature of the map, and then provides readers with the option to drill-down to learn more about the collage.",
	    				"correct":"yes"
	    				},{
						...
						"answer":"Nice try. The description starts by diving into the details and fails to orient the reader with a higher-level overview. The details provided in the description about each state’s specific license plate is also excessive and is likely to overwhelm, rather than facilitate reader comprehension.",
	    				"correct":"no"
	    				}]
    			}];
    			
var how06 = [{	"name":"Example 06",
    				"imageURL": "images/how_example06.jpg",
    				"caption": "",
